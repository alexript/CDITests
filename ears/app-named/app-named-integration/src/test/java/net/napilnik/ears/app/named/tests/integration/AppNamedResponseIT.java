package net.napilnik.ears.app.named.tests.integration;
...
public class AppNamedResponseIT {
    ...
    public static Archive<?> createDeployment() {
        return ShrinkWrap.createFromZipFile(EnterpriseArchive.class, new File("../app-named-ear/target/app-named-ear-1.0-SNAPSHOT.ear"));
    }
